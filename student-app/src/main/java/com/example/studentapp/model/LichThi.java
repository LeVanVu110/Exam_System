...
public class LichThi {
    ...
    public String getLopSV() { return lopSV.get(); }
    public StringProperty lopSVProperty() { return lopSV; }

    public LocalDate getNgayThi() { return ngayThi.get(); }
    public ObjectProperty<LocalDate> ngayThiProperty() { return ngayThi; }
    ...
    public String getSoSV() { return soSV.get(); }
    public StringProperty soSVProperty() { return soSV; }

    public String getHtThi() { return htThi.get(); }
    public StringProperty htThiProperty() { return htThi; }
