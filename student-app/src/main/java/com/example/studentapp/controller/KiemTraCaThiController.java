...
public class KiemTraCaThiController implements Initializable {
    ...
    @FXML private TableColumn<ExamSession, String> colMaCaThi;
    @FXML private TableColumn<ExamSession, String> colTenMonHoc;
    ...
    @FXML private TableColumn<ExamSession, String> colTrangThai;
    @FXML private ProgressIndicator loadingIndicator;
    @FXML private TextField roomFilterField;
    @FXML private TableColumn<ExamSession, Integer> colSoBaiNop;
    @FXML private TableColumn<ExamSession, Integer> colSoMayTrong;
    @FXML private TableColumn<ExamSession, String> colCanBoCoiThi;

    @FXML private TableColumn<ExamSession, Void> colBienBan;
    ...
    private void loadExamsByRoom(String roomName) {
        setLoading(true);
        CompletableFuture<ApiResponse<ExamSession>> future = apiService.fetchExamsByRoomForToday(roomName);
        future.whenComplete((apiResponse, throwable) -> {
            Platform.runLater(() -> {
                setLoading(false);
                if (throwable != null) {
    ...
    private void handleExportButton() {
        ...
        if (file != null) {
            try (FileWriter writer = new FileWriter(file, java.nio.charset.StandardCharsets.UTF_8)) {
                ...
                writer.append('\uFEFF');
                writer.append("Mã Ca Thi,Tên Môn Học,Phòng Thi,Ngày Thi,Giờ Thi,Trạng Thái,Cán bộ coi thi,Số Bài Nộp,Số Máy Trống\n");
    ...
    private void showAlert(String title, String content) {
        Alert.AlertType alertType = title.toLowerCase().contains("lỗi") ? Alert.AlertType.ERROR : Alert.AlertType.INFORMATION;
