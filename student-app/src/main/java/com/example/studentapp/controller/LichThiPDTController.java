...
public class LichThiPDTController implements Initializable {
    ...
    @FXML
    private DatePicker dateNgayThi;
    @FXML
    private TextField txtGioThi;
    @FXML
    private ComboBox<String> comboTrangThai;
    @FXML
    ...
    private void handleSaveButton() {
        ...
        // Giả sử các trường khác trong ExamSession.java đã được thêm (maHP, lopSV,
        // v.v.)
        ...
        CompletableFuture<ApiResponse<ExamSession>> future = apiService.createExamSessionApi(newSession);
            ...
            Platform.runLater(() -> {
                ...
                if (throwable != null) {
                    showAlert(Alert.AlertType.ERROR, "Lỗi Kết Nối",
                            "Không thể tạo lịch thi: " + throwable.getMessage());
                    ...
                    showAlert(Alert.AlertType.ERROR, "Lỗi API",
